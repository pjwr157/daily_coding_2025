...
-- [0.1.🛠️ CREATE 특훈]
-- [0.2.🛠️ insert 특훈] (Study Here & Scroll down for Insert Practice!)
...
insert into 무기 (무기ID, 무기명, 공격력, 가격) values (1,'장검',150,3000);
...
insert into 길드원 (길드원ID, 길드ID, 항해사ID, 가입일자) values (1,1,6,curdate());
